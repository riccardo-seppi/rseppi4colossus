...
mf_tinker=mf.massFunction(sigma_,q_in='sigma', z=0, mdef = 'vir', model = 'tinker08', q_out = 'f') 
mf_bhattacharya=mf.massFunction(sigma_,q_in='sigma', z=0, model = 'bhattacharya11', q_out = 'f') 
